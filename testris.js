...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/js/testris.data';
      var REMOTE_PACKAGE_BASE = 'testris.data';
...
Module['FS_createPath']('/assets', 'shaders', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_build/js/testris.data');

      };
      Module['addRunDependency']('datafile_build/js/testris.data');
   ...
   loadPackage({"files": [{"filename": "/assets/index.html", "start": 0, "end": 3542, "audio": 0}, {"filename": "/assets/sounds/whooop.wav", "start": 3542, "end": 221186, "audio": 1}, {"filename": "/assets/sounds/explosion.wav", "start": 221186, "end": 289598, "audio": 1}, {"filename": "/assets/sounds/hiscore.wav", "start": 289598, "end": 324196, "audio": 1}, {"filename": "/assets/sounds/ready.wav", "start": 324196, "end": 335294, "audio": 1}, {"filename": "/assets/sounds/back.wav", "start": 335294, "end": 348508, "audio": 1}, {"filename": "/assets/sounds/gameover.wav", "start": 348508, "end": 421754, "audio": 1}, {"filename": "/assets/sounds/select.wav", "start": 421754, "end": 431942, "audio": 1}, {"filename": "/assets/sounds/menu.wav", "start": 431942, "end": 442130, "audio": 1}, {"filename": "/assets/sounds/drop1.wav", "start": 442130, "end": 452318, "audio": 1}, {"filename": "/assets/sounds/bloop.wav", "start": 452318, "end": 489988, "audio": 1}, {"filename": "/assets/sounds/drop2.wav", "start": 489988, "end": 500176, "audio": 1}, {"filename": "/assets/sounds/drop3.wav", "start": 500176, "end": 510364, "audio": 1}, {"filename": "/assets/sounds/small-explosion.wav", "start": 510364, "end": 547274, "audio": 1}, {"filename": "/assets/fonts/DroidSansFallbackFull.ttf", "start": 547274, "end": 4580694, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono-Bold.ttf", "start": 4580694, "end": 4912686, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono.ttf", "start": 4912686, "end": 5253398, "audio": 0}, {"filename": "/assets/fonts/Ubuntu-M.ttf", "start": 5253398, "end": 5594722, "audio": 0}, {"filename": "/assets/shaders/vhs.fs", "start": 5594722, "end": 5596217, "audio": 0}, {"filename": "/assets/shaders/bg.fs", "start": 5596217, "end": 5596757, "audio": 0}, {"filename": "/assets/shaders/title.vs", "start": 5596757, "end": 5597241, "audio": 0}, {"filename": "/assets/shaders/default.vs", "start": 5597241, "end": 5597550, "audio": 0}, {"filename": "/assets/shaders/default.fs", "start": 5597550, "end": 5597743, "audio": 0}, {"filename": "/assets/shaders/title.fs", "start": 5597743, "end": 5598157, "audio": 0}], "remote_package_size": 5598157, "package_uuid": "29722b19-84a3-4df0-b0a3-83d7faf1bd64"});
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 100663296;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY (the initial value can be provided on Module, but after startup the value is only looked for on a local variable of that name)') } });
...
var wasmBinaryFile = 'testris.wasm';
...
var ASM_CONSTS = {
  1244: function() {FS.syncfs(true, function (err) { if (err !== null) console.error(err); });},  
 2442: function() {FS.mkdir('/offline'); FS.mount(IDBFS, {}, '/offline'); FS.syncfs(true, function (err) { if (err !== null) console.error(err); });},  
 4251: function($0, $1) {var a = Module.HEAPU8.subarray($0, $0+$1); var data = String.fromCharCode.apply(null, a); localStorage.setItem("highscores", data);},  
 4390: function() {try { var jsString = localStorage.getItem("highscores"); var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToAscii(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; } catch (e) { console.error(e); return null; }},  
 4661: function() {try { var jsString = localStorage.getItem("settings"); var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToAscii(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; } catch (e) { console.error(e); return null; }},  
 4930: function($0) {localStorage.setItem("settings", AsciiToString($0));},  
 5853: function($0, $1, $2, $3) {var a = Module.HEAPU8.subarray($0, $0+$1); var b = Module.HEAPU8.subarray($2, $2+$3); var blob = new Blob([a, b], { type: 'application/octet-stream', }); var url = window.URL.createObjectURL(blob); var dl = document.createElement('a'); dl.href = url; dl.download = (new Date().getTime())+'.tsreplay'; dl.style = 'display: none'; document.body.appendChild(dl); dl.click(); dl.remove(); setTimeout(() => { return window.URL.revokeObjectURL(url); }, 1000);},  
 6329: function($0) {try { var chooser = document.getElementById('fileElem'); chooser.value = ""; chooser.addEventListener('change', function() { if (this.files.length > 0) { this.files[0].arrayBuffer().then(x => { var result = Module.ccall('loadReplay', 'number', ['number', 'array'], [$0, new Uint8Array(x)]); console.log(result); }); } }, {capture: false, once: true}); document.getElementById('fileElem').click(); } catch (e) { console.error(e); return null; }},  
 49484: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 50963: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 51952: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 52045: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 53270: function() {return screen.width;},  
 53297: function() {return screen.height;},  
 53325: function() {return window.innerWidth;},  
 53357: function() {return window.innerHeight;},  
 53435: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 53569: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 53735: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 53961: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 54514: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 54584: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 56236: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 56646: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 57251: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 57731: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }}
};
...
/** @type {function(...*):?} */
var _loadReplay = Module["_loadReplay"] = createExportWrapper("loadReplay");
