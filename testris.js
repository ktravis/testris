...
Module['FS_createPath']('/assets', 'shaders', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/index.html", "start": 0, "end": 3542, "audio": 0}, {"filename": "/assets/sounds/cannon.wav", "start": 3542, "end": 85152, "audio": 1}, {"filename": "/assets/sounds/whooop.wav", "start": 85152, "end": 302796, "audio": 1}, {"filename": "/assets/sounds/crash.wav", "start": 302796, "end": 367494, "audio": 1}, {"filename": "/assets/sounds/hiscore.wav", "start": 367494, "end": 402092, "audio": 1}, {"filename": "/assets/sounds/ready.wav", "start": 402092, "end": 413190, "audio": 1}, {"filename": "/assets/sounds/flap.wav", "start": 413190, "end": 446408, "audio": 1}, {"filename": "/assets/sounds/birddeath.wav", "start": 446408, "end": 456596, "audio": 1}, {"filename": "/assets/sounds/playerdeath.wav", "start": 456596, "end": 490060, "audio": 1}, {"filename": "/assets/sounds/smallflap.wav", "start": 490060, "end": 500248, "audio": 1}, {"filename": "/assets/sounds/laser.wav", "start": 500248, "end": 815242, "audio": 1}, {"filename": "/assets/fonts/DroidSansFallbackFull.ttf", "start": 815242, "end": 4848662, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono-Bold.ttf", "start": 4848662, "end": 5180654, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono.ttf", "start": 5180654, "end": 5521366, "audio": 0}, {"filename": "/assets/fonts/Ubuntu-M.ttf", "start": 5521366, "end": 5862690, "audio": 0}, {"filename": "/assets/shaders/vhs.fs", "start": 5862690, "end": 5864185, "audio": 0}, {"filename": "/assets/shaders/bg.fs", "start": 5864185, "end": 5864725, "audio": 0}, {"filename": "/assets/shaders/title.vs", "start": 5864725, "end": 5865209, "audio": 0}, {"filename": "/assets/shaders/default.vs", "start": 5865209, "end": 5865518, "audio": 0}, {"filename": "/assets/shaders/default.fs", "start": 5865518, "end": 5865711, "audio": 0}, {"filename": "/assets/shaders/title.fs", "start": 5865711, "end": 5866125, "audio": 0}], "remote_package_size": 5866125, "package_uuid": "bfd60daf-497b-4133-8f84-e2cc2f31a9e2"});
...
var ASM_CONSTS = {
 ...
 2411: function() {FS.mkdir('/offline'); FS.mount(IDBFS, {}, '/offline'); FS.syncfs(true, function (err) { if (err !== null) console.error(err); });},  
 4197: function($0, $1) {var a = Module.HEAPU8.subarray($0, $0+$1); var data = String.fromCharCode.apply(null, a); localStorage.setItem("highscores", data);},  
 4336: function() {try { var jsString = localStorage.getItem("highscores"); var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToAscii(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; } catch (e) { console.error(e); return null; }},  
 4607: function() {try { var jsString = localStorage.getItem("settings"); var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToAscii(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; } catch (e) { console.error(e); return null; }},  
 4876: function($0) {localStorage.setItem("settings", AsciiToString($0));},  
 5522: function($0, $1, $2, $3) {var a = Module.HEAPU8.subarray($0, $0+$1); var b = Module.HEAPU8.subarray($2, $2+$3); var blob = new Blob([a, b], { type: 'application/octet-stream', }); var url = window.URL.createObjectURL(blob); var dl = document.createElement('a'); dl.href = url; dl.download = (new Date().getTime())+'.tsreplay'; dl.style = 'display: none'; document.body.appendChild(dl); dl.click(); dl.remove(); setTimeout(() => { return window.URL.revokeObjectURL(url); }, 1000);},  
 5998: function($0) {try { var chooser = document.getElementById('fileElem'); chooser.value = ""; chooser.addEventListener('change', function() { if (this.files.length > 0) { this.files[0].arrayBuffer().then(x => { var result = Module.ccall('loadReplay', 'number', ['number', 'array'], [$0, new Uint8Array(x)]); console.log(result); }); } }, {capture: false, once: true}); document.getElementById('fileElem').click(); } catch (e) { console.error(e); return null; }},  
 48556: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 50035: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 51024: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 51117: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 52342: function() {return screen.width;},  
 52369: function() {return screen.height;},  
 52397: function() {return window.innerWidth;},  
 52429: function() {return window.innerHeight;},  
 52507: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 52641: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 52807: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
