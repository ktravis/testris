...
Module['FS_createPath']('/assets', 'fonts', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/index.html", "start": 0, "end": 3144, "audio": 0}, {"filename": "/assets/sounds/laser.wav", "start": 3144, "end": 318138, "audio": 1}, {"filename": "/assets/sounds/playerdeath.wav", "start": 318138, "end": 351602, "audio": 1}, {"filename": "/assets/sounds/birddeath.wav", "start": 351602, "end": 361790, "audio": 1}, {"filename": "/assets/sounds/ready.wav", "start": 361790, "end": 372888, "audio": 1}, {"filename": "/assets/sounds/crash.wav", "start": 372888, "end": 437586, "audio": 1}, {"filename": "/assets/sounds/flap.wav", "start": 437586, "end": 470804, "audio": 1}, {"filename": "/assets/sounds/hiscore.wav", "start": 470804, "end": 505402, "audio": 1}, {"filename": "/assets/sounds/cannon.wav", "start": 505402, "end": 587012, "audio": 1}, {"filename": "/assets/sounds/smallflap.wav", "start": 587012, "end": 597200, "audio": 1}, {"filename": "/assets/shaders/bg.fs", "start": 597200, "end": 597740, "audio": 0}, {"filename": "/assets/shaders/default.vs", "start": 597740, "end": 598049, "audio": 0}, {"filename": "/assets/shaders/default.fs", "start": 598049, "end": 598242, "audio": 0}, {"filename": "/assets/shaders/title.fs", "start": 598242, "end": 598656, "audio": 0}, {"filename": "/assets/shaders/title.vs", "start": 598656, "end": 599140, "audio": 0}, {"filename": "/assets/fonts/DroidSansFallbackFull.ttf", "start": 599140, "end": 4632560, "audio": 0}, {"filename": "/assets/fonts/Ubuntu-M.ttf", "start": 4632560, "end": 4973884, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono.ttf", "start": 4973884, "end": 5314596, "audio": 0}, {"filename": "/assets/fonts/DejaVuSansMono-Bold.ttf", "start": 5314596, "end": 5646588, "audio": 0}], "remote_package_size": 5646588, "package_uuid": "2b779c8e-e812-49f7-8068-27bc6faab6c0"});
...
var ASM_CONSTS = {
 ...
 43196: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 44675: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 45664: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 45757: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 46982: function() {return screen.width;},  
 47009: function() {return screen.height;},  
 47037: function() {return window.innerWidth;},  
 47069: function() {return window.innerHeight;},  
 47147: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 47281: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 47447: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
