...
var STACK_BASE = 45001936,
    STACKTOP = STACK_BASE,
    STACK_MAX = 39759056,
    DYNAMIC_BASE = 45001936;
...
var ASM_CONSTS = {
 ...
 4241: function() {try { var jsString = localStorage.getItem("settings"); var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToAscii(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; } catch (e) { console.error(e); return null; }},  
 4510: function($0) {localStorage.setItem("settings", AsciiToString($0));},  
 ...
 48563: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 49552: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 49645: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 50870: function() {return screen.width;},  
 50897: function() {return screen.height;},  
 50925: function() {return window.innerWidth;},  
 50957: function() {return window.innerHeight;},  
 51035: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 51169: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 51335: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
